...
var Aufgabe8;
(function (Aufgabe8) {
    var BlueFlower = (function (_super) {
        __extends(BlueFlower, _super);
        function BlueFlower(_x, _y) {
            var _this = _super.call(this, _x, _y, "blue") || this;
            _this.draw();
            return _this;
        }
        BlueFlower.prototype.draw = function () {
            var color = "#11BAF9";
            var blaetter = 3;
    ...
    Aufgabe8.BlueFlower = BlueFlower;
})(Aufgabe8 || (Aufgabe8 = {}));
